...
@onready var efecto_veneno = $EfectoVeneno # <-- NUEVO: Referencia al nodo del efecto
...
func _ready() -> void:
	...
	# --- NUEVO: Ocultar el efecto de veneno al iniciar el juego ---
	if efecto_veneno:
		efecto_veneno.visible = false
